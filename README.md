%%{init: {'theme': 'base', 'themeVariables': { 'primaryColor': '#5f7c8a', 'primaryTextColor': '#ffffff', 'primaryBorderColor': '#3a4d57', 'lineColor': '#333333', 'fontFamily': 'Arial, sans-serif'}, 'flowchart': {'nodeSpacing': 25, 'rankSpacing': 30}}}%%
